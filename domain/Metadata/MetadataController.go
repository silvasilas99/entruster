...
func createMetadata(contract *client.Contract) gin.HandlerFunc {
    return func(c *gin.Context) {
        var req metadata.MetadataModel
        if err := c.ShouldBindJSON(&req); err != nil {
            utils.SendError(c, http.StatusBadRequest, "Invalid request body. Check the required fields and their types.")
            return
        }
        // Step 2 — call service layer
        if err := metadata.RegisterMetadata(contract, req); err != nil {
...
func getAllMetadata(contract *client.Contract) gin.HandlerFunc {
	return func(c *gin.Context) {
		metadataList, err := metadata.GetAllMetadata(contract)
		if err != nil {
			utils.SendError(c, http.StatusInternalServerError, err.Error())
			return
		}
...
func getMetadataByDID(contract *client.Contract) gin.HandlerFunc {
	return func(c *gin.Context) {
		...
		// 	return
		// }
		// metadata, err := metadata.GetMetadataByDID(contract, id)
		// if err != nil {
		// 	utils.SendError(c, http.StatusInternalServerError, err.Error())
		// 	return
		// }
...
func updateMetadata(contract *client.Contract) gin.HandlerFunc {
	return func(c *gin.Context) {
...
func deleteMetadata(contract *client.Contract) gin.HandlerFunc {
	return func(c *gin.Context) {
		...
		// 	return
		// }
		// err := metadata.DeleteMetadata(contract, id)
		// if err != nil {
		// 	utils.SendError(c, http.StatusInternalServerError, err.Error())
		// 	return
		// }
...
func exportMetadataAsCsv(contract *client.Contract) gin.HandlerFunc {
	return func(c *gin.Context) {
